        ...
        submitButton.addEventListener('click', function (e) {
            ...
            validator.validate().then(function(status) {
		        if (status == 'Valid') {
                    ...
                    // join first and last name to name in form
                    var name = form.querySelector('[name="first-name"]').value + ' ' + form.querySelector('[name="last-name"]').value;
                    ...
                    $.ajax({
                        ...
                        Swal.fire({
                            ...
                            text: "Welcome to Rehoboth Traders family! Please check your email to verify your account.",
                            icon: "success",
                        });
