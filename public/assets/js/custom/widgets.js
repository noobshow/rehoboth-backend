...
var KTWidgets = function () {
    ...
    var initMixedWidget17 = function() {
        var element = document.getElementById("get_funded_upto_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
                ...
                radialBar: {
                    ...
                    dataLabels: {
                        ...
                        value: {
                            ...
                            show: true,
                            formatter: function(val) {
                                return "$2m+"; // Add "$" prefix and "m+" suffix
                            }
                        }
                    },
                    track: {
    ...
    var initRecentTransactionsWidget = function() {
        var charts = document.querySelectorAll('.recent-transactions-chart');
        ...
        [].slice.call(charts).map(function(element) {
            ...
            var options = {
                ...
                yaxis: {
                    min: 0,
                    //set this max to an attribute in the html element
                    max: 1000, 
                    labels: {
                        show: false,
                        style: {
