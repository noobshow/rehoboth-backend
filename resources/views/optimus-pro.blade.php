											...
											<table id="zoomable-table" class="table table-bordered border-secondary table-rounded border align-middle text-center"><!-- gs-0 gy-4 -->
												...
												<tbody id="optimus_pro_signals">
													...
													<tr style="cursor: crosshair;" id="optimus_pro_signal_asset_{{ strtolower($assetData->asset) }}">
														...
														<td>
															<button id="optimus_pro_signal_{{ strtolower($assetData->asset) }}_fundamental" class="btn mb-1 w-100 btn-sm fw-bolder {{ $assetData->fundamental == 'Buy' ? 'btn-linkedin' : 'btn-danger' }} {{ !empty($assetData->fundamental) ? 'd-block' : 'd-none' }}">
																{{ $assetData->fundamental }}
															</button>
														</td>
														<td>
															<button id="optimus_pro_signal_{{ strtolower($assetData->asset) }}_technical" class="btn mb-1 w-100 btn-sm fw-bolder {{ $assetData->technical == 'Buy' ? 'btn-linkedin' : 'btn-danger' }} {{ !empty($assetData->technical) ? 'd-block' : 'd-none' }}">
																{{ $assetData->technical }}
															</button>
														</td>
														<td>
															<button id="optimus_pro_signal_{{ strtolower($assetData->asset) }}_sentiment" class="btn mb-1 w-100 btn-sm fw-bolder {{ $assetData->sentiment == 'Buy' ? 'btn-linkedin' : 'btn-danger' }} {{ !empty($assetData->sentiment) ? 'd-block' : 'd-none' }}">
																{{ $assetData->sentiment }}
															</button>
														</td>
														<td>
															<button id="optimus_pro_signal_{{ strtolower($assetData->asset) }}_strategy" class="btn mb-1 w-100 btn-sm fw-bolder {{ $assetData->strategy == 'Buy' ? 'btn-linkedin' : 'btn-danger' }} {{ !empty($assetData->strategy) ? 'd-block' : 'd-none' }}">
																{{ $assetData->strategy }}
															</button>
														</td>
														<!-- <td>
