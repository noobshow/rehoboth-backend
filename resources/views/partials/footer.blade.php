<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
	...
	<div class="container-xxl d-flex flex-column flex-md-row align-items-center justify-content-between">
		<!--begin::Copyright-->
		<div class="text-dark order-2 order-md-1">
			<span class="fw-bold me-1">Risk Warning and Disclaimer</span>
		</div>
		<!--end::Copyright-->
	</div>
	<!--end::Container-->
	<!--begin::Container-->
	<div class="container-xxl pt-5 d-flex flex-column flex-md-row align-items-center justify-content-between">
		<!--begin::Disclaimer-->
		<div class="text-dark order-2 order-md-1">
