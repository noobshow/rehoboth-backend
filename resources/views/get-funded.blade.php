                                                ...
                                                <table class="table align-middle"><!-- gs-0 gy-4 -->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
																<a href="javacript:void(0)" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 actively-funded-account"  data-clipboard-text="Login: {{ $active_account->mt5_login }} \n Password: {{ $active_account->mt5_password }} \n Server: {{ $active_account->mt5_server }}">  
